...
object Lesson1_RDD {
  ...
  def RddCreationOperation(spark:SparkSession):Unit={
    ...
    * operation that modifies an RDD returns a new RDD with the modified data.*/
    ...
    val readMePath="/DATA/data_set/spark/basics/Lesson1_RDD/README.md"
    ...
    * other Hadoop-supported storage system.*/
    ...
    val allRdd=sc.textFile("/DATA/data_set/spark/basics/Lesson1_RDD/*.txt")
    val allRddFromLessson1 = sc.wholeTextFiles("/DATA/data_set/spark/basics/Lesson1_RDD/*.txt")
...
* you call this method.*/
    ...
    val df=spark.read.format("csv").option("header","true").load("/DATA/data_set/spark/basics/Lesson1_RDD/satisfait_client.csv")
    df.show()
    val dfToRdd=df.rdd
...
val client_sat_lines=sc.textFile("/DATA/data_set/spark/basics/Lesson1_RDD/satisfait_client.data")
  ...
  def RddTransformationOperation(spark:SparkSession):Unit={
    ...
    * in the original RDD*/
    val logRDD= spark.sparkContext.textFile("/DATA/data_set/spark/basics/Lesson1_RDD/log.log")
  ...
  * Note that the groupBy method is an expensive operation since it may shuffle data.*/
   ...
   case class client_satisfait(manager_name:String,  client_name:String, client_gender:String, client_age:Int, response_time:Double, statisfaction_level:Double)
    val client_sat_lines=spark.sparkContext.textFile("/DATA/data_set/spark/basics/Lesson1_RDD/satisfait_client.data")
...
* if called on a very large RDD.*/
  ...
  * */
  def RddCachingOperations(spark:SparkSession):Unit={
    val logPath="file:///DATA/data_set/spark/basics/Lesson1_RDD/log.log"
